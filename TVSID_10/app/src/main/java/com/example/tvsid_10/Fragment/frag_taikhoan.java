...
import static com.example.tvsid_10.Activity.Home.chipNavigationBar;
...
import com.example.tvsid_10.Activity.FaceUpdateActivity;
import com.example.tvsid_10.Common.Common;
import com.example.tvsid_10.R;
import com.example.tvsid_10.Activity.UpdateThongTin;
...
public class frag_taikhoan extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.tv_capnhatkhuonmat).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
